...
def test_scoped_codemode_description_includes_capability_schema() -> None:
    ...
    assert "helpers such as all, any, min, and max are unavailable" in scoped.description
...
def test_compatibility_codemode_description_explains_output_contract() -> None:
    ...
    assert "helpers such as all, any, min, and max are unavailable" in codemode.description
